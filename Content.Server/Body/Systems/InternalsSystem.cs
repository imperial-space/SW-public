...
public sealed class InternalsSystem : SharedInternalsSystem
{
    ...
    private void OnInhaleLocation(Entity<InternalsComponent> ent, ref InhaleLocationEvent args)
    {
        if (AreInternalsWorking(ent))
        {
            ...
            args.Gas = _gasTank.RemoveAirOutput((ent.Comp.GasTankEntity.Value, gasTank), args.Respirator.BreathVolume); // Imperial Medieval: RemoveAirVolume -> RemoveAirOutput
            // TODO: Should listen to gas tank updates instead I guess?
            //_alerts.ShowAlert(ent.Owner, ent.Comp.InternalsAlert, GetSeverity(ent)); # Imperial Medieval
        }
    }
}
