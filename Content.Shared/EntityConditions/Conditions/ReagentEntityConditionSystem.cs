...
public sealed partial class ReagentCondition : EntityConditionBase<ReagentCondition>
{
    ...
    {
        // Guard empty ProtoId — Resolve throws ArgumentNullException on null/empty keys.
        if (string.IsNullOrEmpty(Reagent.Id) || !prototype.Resolve(Reagent, out var reagentProto))
            return String.Empty;
