...
namespace Content.Shared.Preferences
{
    ...
    public sealed partial class HumanoidCharacterProfile
    {
        ...
        private static readonly Regex RestrictedNameRegex = new(@"[^A-Za-zА-ЯЁа-яё0-9' -]"); // Imperial Medieval
        ...
        public HumanoidCharacterProfile(
            ...
            Dictionary<string, int>? skills = null) // imperial medieval
        {
            Name = name;
            ...
            _loadouts = loadouts;
            // imperial medieval start
            Skills = skills ?? new Dictionary<string, int>();
            // imperial medieval end
        ...
        public HumanoidCharacterProfile(HumanoidCharacterProfile other)
            : this(other.Name,
                ...
                other.Skills) // imperial medieval
        {
        }
        ...
        public bool MemberwiseEquals(HumanoidCharacterProfile other)
        {
            ...
            if (!Skills.Equals(other.Skills)) return false; // imperial medieval
