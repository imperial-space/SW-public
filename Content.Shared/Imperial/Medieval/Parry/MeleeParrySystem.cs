...
namespace Content.Shared.MeleeParry
{
    public sealed partial class MeleeParrySystem : EntitySystem
    {
        ...
        { // Захардкожено для деревянного меча
            ...
            foreach (var itemH in _inventory.GetHandOrInventoryEntities(uid, SlotFlags.All)) // TODO: убрать NONE, вызывающий дебаг ассерт
            {
            ...
            foreach (var item in _inventory.GetHandOrInventoryEntities(uid, SlotFlags.All)) // TODO: убрать NONE, вызывающий дебаг ассерт
            {
