...
medieval-myrmex-stew-remaining-pieces = Осталось [bold]{ $uses }[/bold] кусочков

medieval-myrmex-buff-health-examine = [bold]Получаемые повреждения[/bold] [color=green]x{$value}[/color]
