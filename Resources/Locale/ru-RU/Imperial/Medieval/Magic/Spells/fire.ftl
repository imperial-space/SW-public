...
medieval-store-spells-fire-magic-arrow-player-follover-middle-desc = Выпустите до четырех самонаводящихся стрел. Стоимость 35 маны. Используйте среднюю кнопку мыши для выбора нескольких целей.
