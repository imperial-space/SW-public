trade-terminal-window-title = Торговый кристалл: {$name}

trade-terminal-dir-title    = Настроенные кристаллы
trade-terminal-dir-hint     = Выберите кристалл для духовной связи.
trade-terminal-dir-empty    = В округе нет откликающихся кристаллов.
trade-terminal-dir-free     = Покоится
trade-terminal-dir-busy     = Резонирует

trade-terminal-btn-call             = Воззвать
trade-terminal-btn-hang-up          = Разорвать связь
trade-terminal-btn-accept           = Ответить на зов
trade-terminal-btn-decline          = Отвергнуть
trade-terminal-btn-confirm          = Скрепить договор
...
trade-terminal-countdown-self       = Начат ритуал закрепления ({$seconds} с). Партнёр может прервать его.
trade-terminal-countdown-partner    = {$name} скрепляет договор ({$seconds} с). Вы можете прервать его.
trade-terminal-countdown-cancelled  = Ритуал закрепления был разрушен.
trade-terminal-countdown-cancelled-partner = {$name} разрушил(а) ритуал закрепления.
trade-terminal-completed            = Дары успешно обменяны!
trade-terminal-btn-unconfirm        = Снять печать
trade-terminal-verb-open            = Коснуться кристалла
