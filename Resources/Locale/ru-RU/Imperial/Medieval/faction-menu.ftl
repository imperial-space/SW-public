...
medieval-relations-error = П0. Подозрительная активность с отношениями фракций. Перманентно. Если бан ложный - откройте баг репорт и аппеляцию на дискорд сервере
