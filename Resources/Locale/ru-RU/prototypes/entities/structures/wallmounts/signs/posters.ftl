...
ent-PosterContrabandRouny = Вы видели его?
    .desc = Старый плакат о пропавшем пришельце. Куда он сбежал?
ent-PosterLegitTyrone = Путеводитель Тайрона по космосу
    .desc = Плакат, рекламирующий онлайн-школу о космосе. Перечисленные занятия, похоже, охватывают все: от базового использования оборудования станции до таких сложных тем, как создание трубных бомб или покрытие целых коридоров космической смазкой. Отказ от ответственности гласит:\"Участие никогда не заканчивается плохо, и в конце вы даже можете получить тортилью.\