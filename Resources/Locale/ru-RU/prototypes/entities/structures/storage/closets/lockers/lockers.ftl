...
ent-LockerPrisoner2 = шкаф заключенного
    .desc = Это надежный шкафчик для хранения личных вещей заключенных во время их пребывания в тюрьме.
ent-LockerPrisoner3 = шкаф заключенного
    .desc = Это надежный шкафчик для хранения личных вещей заключенных во время их пребывания в тюрьме.
ent-LockerPrisoner4 = шкаф заключенного
    .desc = Это надежный шкафчик для хранения личных вещей заключенных во время их пребывания в тюрьме.
ent-LockerPrisoner5 = шкаф заключенного
    .desc = Это надежный шкафчик для хранения личных вещей заключенных во время их пребывания в тюрьме.
ent-LockerPrisoner6 = шкаф заключенного
    .desc = Это надежный шкафчик для хранения личных вещей заключенных во время их пребывания в тюрьме.
ent-LockerPrisoner7 = шкаф заключенного
    .desc = Это надежный шкафчик для хранения личных вещей заключенных во время их пребывания в тюрьме.
ent-LockerPrisoner8 = шкаф заключенного
    .desc = Это надежный шкафчик для хранения личных вещей заключенных во время их пребывания в тюрьме.
