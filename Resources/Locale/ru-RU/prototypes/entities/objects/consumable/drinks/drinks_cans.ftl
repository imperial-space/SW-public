...
ent-DrinkLemonLimeCan = банка лимон-лайма
    ...
    .suffix = { "" }
ent-DrinkLemonLimeCranberryCan = банка Смите Кранберри
    .desc = Хотите Смите Кранберри? Любимец администраторов по всему миру. Пейте умеренно. Ограниченная партия к праздникам!
    .suffix = { "" }
