...
werewolf-brown = Brown fur
werewolf-light = Light fur
werewolf-purple = Purple fur
werewolf-red = Red fur

round-end-lycantropy-werewolf-count-summary = There were [color=crimson]{ $count }[/color] werewolves in total:
round-end-lycantropy-werewolf-summary = [color=crimson]- { $name }[/color]

guide-entry-werewolf = Werewolves