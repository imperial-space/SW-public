...
public sealed class CharacterInfoSystem : EntitySystem
{
    ...
    private void OnCharacterInfoEvent(CharacterInfoEvent msg, EntitySessionEventArgs args)
    {
        ...
        var data = new CharacterData(entity, msg.JobTitle, msg.Objectives, msg.Briefing, Name(entity), msg.Faction);    // Imperial medieval faction menu tweaked
    ...
    public readonly record struct CharacterData(
        ...
        string? Briefing,
        string EntityName,
        List<string> Faction    // Imperial medieval faction menu
    );
