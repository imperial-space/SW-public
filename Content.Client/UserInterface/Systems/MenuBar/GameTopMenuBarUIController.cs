...
public sealed class GameTopMenuBarUIController : UIController
{
    ...
    [Dependency] private readonly LanguageMenuUIController _language = default!; // imperial medieval
    ...
    public void UnloadButtons()
    {
        ...
        _language.UnloadButton(); // imperial medieval
    }
    ...
    public void LoadButtons()
    {
        ...
        _sandbox.LoadButton();
        _emotes.LoadButton();
        _language.LoadButton(); // imperial medieval
    }
}
