...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class HumanoidProfileEditor : BoxContainer
    {
        ...
        // Imperial Medieval Flavor Images
        private readonly Imperial.Medieval.Flavors.ClientFlavorManager _flavors;
        private readonly Shared.Players.PlayTimeTracking.ISharedPlaytimeManager _playtime;
        ...
        public HumanoidProfileEditor(
            ...
            // Imperial Medieval Flavor Images
            Imperial.Medieval.Flavors.ClientFlavorManager flavors,
            Shared.Players.PlayTimeTracking.ISharedPlaytimeManager playtime)
        {
            ...
            SpeciesButton.OnItemSelected += args =>
            {
                ...
                // Imperial Medieval: ensure skin UI syncs after species change
                UpdateSkinColor();
            ...
            // Imperial Medieval skills (tab index 1)
            RefreshSkills();

            #region Jobs

            // Imperial Medieval: jobs tab shifted 1 -> 2 for skills tab
            ...
            // Imperial Medieval: antags tab shifted 2 -> 3 for skills tab
            ...
            // Imperial Medieval: markings tab shifted 4 -> 5 for skills tab
