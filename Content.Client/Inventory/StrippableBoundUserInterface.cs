...
namespace Content.Client.Inventory
{
    ...
    public sealed class StrippableBoundUserInterface : BoundUserInterface
    {
        ...
        protected override void Open()
        {
            ...
            _strippingMenu.Title = Loc.GetString("strippable-bound-user-interface-stripping-menu-title", ("ownerName", Identity.Name(Owner, EntMan, _player.LocalEntity))); // Imperial medieval - added localentity for identity purposes
        }
